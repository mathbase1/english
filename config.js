(function (root, factory) {
  ...
  "contentGroups": [
    {
      ...
      "supportedInterpretations": [
        ...
        "the world seems hard to see clearly"
      ],
      "supportedMethods": [
        "imagery",
        "adjective"
  ...
  "calibrationCases": [
    ...
    {
      "id": "test11",
      "label": "Ordinary competent low Level 3",
      "expectedMark": 5,
    ...
    {
      "id": "test12",
      "label": "Quote then explain in adjacent sentence",
      "expectedMark": 5,
    ...
    {
      "id": "test13",
      "label": "Brief but valid analysis",
      "expectedMark": 5,
    ...
    },
    {
      ...
      "expectedMark": 8,
      "answer": "The writer turns Rosabel’s journey into a clash between fantasy and grim reality. Through the misted windows the jewellers’ shops become \"opal and silver\" \"fairy palaces\", so ordinary streets are refracted into something luxurious and unreal. This momentary transformation feels like a brief escape into imagination, which makes the return to her body even harsher: she is \"horribly wet\" and coated in \"black, greasy mud\". Inside the bus, the \"sickening smell of warm humanity\" and the verb \"oozing\" make the passengers feel oppressively close, as if the atmosphere itself is suffocating her. By the end, the crowd resolving into \"one meaningless, staring face\" strips people of individuality altogether, so Rosabel’s view becomes not just tired but dehumanised and emotionally numbed."
    },
    {
      "id": "test15",
      "label": "Loose terminology but sound interpretation",
      "expectedMark": 6,
    ...
    {
      "id": "test16",
      "label": "Mixed response with enough clear analysis",
      "expectedMark": 5,
  ...
  "levelDescriptors": {
    ...
    "Level 1": "Simple or limited comments; mostly retelling, listing, or generic statement.",
    "Level 2": "Some relevant explanation, but often literal, uneven, or weakly developed.",
    "Level 3": "Clear, relevant analysis with apt evidence, though not consistently perceptive.",
    "Level 4": "Perceptive, consistently accurate analysis with selective evidence and sustained insight."
  }
};
});
